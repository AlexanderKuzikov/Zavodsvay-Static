...
- **Фильтр по категориям на карте** — интерактивная легенда, solo-click, reset, счётчик
...
- [x] Фильтрация по категориям на общей карте — **готово**
...
- Есть кнопка `Показать все`
- Есть счётчик `показано N из M`
