...
- **Карта на странице объекта** — центрирование на объекте zoom 13, пульсирующий маркер текущего объекта, навигация по остальным
...
- [ ] **Фильтрация / поиск на карте** — обсуждается (см. ниже)
...
9. **Фильтрация / поиск на карте.** Архитектура не определена — обсуждается.
...
> Это подтверждено эмпирически: объекты на карте отображаются точно, без сдвига.
