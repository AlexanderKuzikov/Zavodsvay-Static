...
11. **Номенклатура диаметров свай.** Диаметры в прайсе (60, 73, 102, 114 мм) не совпадают с диаметрами в каталоге (57, 76, 89, 108... мм). Ждём ответа заказчика — что является актуальной номенклатурой. После ответа обновить либо каталог, либо прайс.
