...
4. **`build.php` в Zavodsvay vs в WebForge.** Писать `build.php` здесь как прототип (и потом портировать), или дождаться WebForge-генератора? Влияет на приоритет зандач.
